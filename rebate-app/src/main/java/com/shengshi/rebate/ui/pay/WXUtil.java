...
public class WXUtil {
    ...
    public static byte[] readFromFile(String fileName, int offset, int len) {
        ...
        if (!file.exists()) {
            Log.i("readFromFile: file not found");
            return null;
        }
        ...
        Log.d("readFromFile : offset = " + offset + " len = " + len + " offset + len = " + (offset + len));
    ...
    public static Bitmap extractThumbNail(final String path, final int height, final int width, final boolean crop) {
        ...
        try {
            ...
            Log.d("extractThumbNail: round=" + width + "x" + height + ", crop=" + crop);
            ...
            Log.i("bitmap required size=" + newWidth + "x" + newHeight + ", orig=" + options.outWidth + "x" + options.outHeight + ", sample=" + options.inSampleSize);
            ...
            Log.i("bitmap decoded size=" + bm.getWidth() + "x" + bm.getHeight());
            ...
            if (crop) {
                ...
                bm.recycle();
                bm = cropped;
                Log.i("bitmap croped size=" + bm.getWidth() + "x" + bm.getHeight());
            }
            return bm;
