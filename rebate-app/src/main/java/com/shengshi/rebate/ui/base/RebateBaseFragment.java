 ...
 * <p>Update Comments:
 */
public abstract class RebateBaseFragment extends BaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        imageLoader = RebateImageLoader.getInstance(mContext);//保证优先初始化
    ...
    protected RatingBar findRatingBarById(View view, int id) {
